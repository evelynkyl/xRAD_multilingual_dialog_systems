...
QUERY_MODEL_TYPES = ['bert', 'bert_from_parlai_rag', 'dropout_poly', 'mbert_from_cora']
PRETRAINED_RANKER_TYPES = ['wikito', 'reddit']
SMALL_INDEX_TYPES = [None, 'none', 'exact', 'compressed']

""" mDPR Only"""
mDPR_MODEL = 'izoo:cora/mDPR_biencoder_best/mDPR_biencoder_best.cpt'
MULTILINGUAL_WIKI_PASSPAGES_PATH = 'izoo:cora/all_w100.tsv'
MULTILINGUAL_WIKI_INDEX_PATH = 'izoo:cora/embeddings'
MULTILINGUAL_WIKIPEDIA_COMPRESSED_INDEX = 'izoo:cora/emb_index/IVF4096_HNSW128__PQ128.index'
MULTILINGUAL_WIKIPEDIA_EXACT_INDEX  = '/root/cora/embed_index_exact' #'izoo:cora/emb_index_exact'
""""""""""""""""""""""""""""""
...
def setup_rag_args(parser: ParlaiParser) -> ParlaiParser:
    ...
    group.add_argument(
        ...
        choices=['transformer/generator', 'bart', 't5', 'mGEN'],
    )
    group.add_argument(
        '--query-model',
        type=str,
        default='mbert_from_cora',
    ...
    dense_retriever_group.add_argument(
        '--path-to-index',
        type=str,
        default=MULTILINGUAL_WIKIPEDIA_COMPRESSED_INDEX,
        help='path to FAISS Index.',
    )
    dense_retriever_group.add_argument(
        '--path-to-dense-embeddings',
        type=str,
        default=MULTILINGUAL_WIKI_INDEX_PATH,
    ...
    dense_retriever_group.add_argument(
        '--dpr-model-file', type=str, default=mDPR_MODEL, help='path to DPR Model.'
    )
    dense_retriever_group.add_argument(
        '--path-to-dpr-passages',
        type=str,
        default=MULTILINGUAL_WIKI_PASSPAGES_PATH,
