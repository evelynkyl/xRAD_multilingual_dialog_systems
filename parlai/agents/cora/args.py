...
def setup_rag_args(parser: ParlaiParser) -> ParlaiParser:
    ...
    dense_retriever_group.add_argument(
        '--path-to-index',
        type=str,
        default=WIKIPEDIA_COMPRESSED_INDEX, #MULTILINGUAL_WIKIPEDIA_COMPRESSED_INDEX,
    ...
    dense_retriever_group.add_argument(
        ...
        type=str,
        default=WIKIPEDIA_ZOO_PASSAGES, #WIKIPEDIA_ZOO_PASSAGES # #MULTILINGUAL_WIKI_PASSPAGES_PATH,
