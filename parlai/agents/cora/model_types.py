...
from parlai.agents.cora.modules import RagDecoder, CoraModel
...
class RagModelInterface(ABC):
    ...
    def set_input_turn_cnt_vec(
            self, observation: Message, model: CoraModel, query_str: str
    ) -> Message:
        """
    ...
    ############################
    @abstractmethod
    def augment_batch_for_generation(self, batch: Batch, model: CoraModel) -> Batch:
        """
