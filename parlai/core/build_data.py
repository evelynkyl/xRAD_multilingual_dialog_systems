...
def modelzoo_path(datapath, path):
    ...
    if (
        ...
        print("got internal zoo!")
       # zoo_path = 'parlai_internal/zoo/.internal_zoo_path'
        zoo_path = '/home/evelyn/parley/parlai_internal/zoo/.internal_zoo_path'
        logging.info(f"this is zoo path: {zoo_path}")
        if not PathManager.exists(zoo_path):#'parlai_internal/zoo/.internal_zoo_path'):
            raise RuntimeError(
