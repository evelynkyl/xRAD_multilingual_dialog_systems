...
class TranslatorPerTurnEvalTurkLikeAgent(TranslatorTurkLikeAgent):
    ...
    def act(self, timeout=None):
        ...
        that the conversation history stays the same.
        """
        import parlai.crowdsourcing.tasks.pairwise_per_turn_eval.worlds
        ...
        translator = MarianTranslator(parlai.crowdsourcing.tasks.pairwise_per_turn_eval.worlds.greeting_in_lang) #final_message_text)
