...
class DefaultTeacher(ParlAIDialogTeacher):
    def __init__(self, opt, shared=None):
        ...
        # get datafile
        take_file = f"/home/evelyn/parley/data/tydiqa/tgt_language/{suffix}.txt"
        opt['parlaidialogteacher_datafile'] = take_file

        super().__init__(opt, shared)
        

# "/home/evelyn/ParlAI/parlai/tasks/tydiqa" # 
def _path(opt, filtered):
    ...
    #print(dt)
  #  return os.path.join(opt['datapath'], 'tydiqa', dt + '.txt')
