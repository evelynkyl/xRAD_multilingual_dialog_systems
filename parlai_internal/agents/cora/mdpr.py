...
from parlai_internal.agents.cora.args import mDPR_MODEL
from parlai_internal.agents.cora.conversion_utils import BertConversionUtils
...
class mDPRAgent(TransformerRankerAgent):
    ...
    def __init__(self, opt, shared=None):
        config: BertConfig = BertConfig.from_pretrained('bert-base-multilingual-cased')
    ...
    def __init__(
        ...
        try:
            ...
            config_path = PathManager.get_local_path(
                os.path.join(opt['datapath'], "bert-base-multilingual-cased", self.CONFIG_PATH)
            )
