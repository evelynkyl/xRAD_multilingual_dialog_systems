...
from parlai_internal.agents.mgen import (
    ParlaimGENEncoder,
    ParlaimGENDecoder,
    build_mGEN,
    set_device,
...
from parlai_internal.agents.cora.retrievers import retriever_factory, Document
...
class mGENRagModel(CoraModel):
    ...
    def build_encoder(
        ...
        **kwargs,
        ...
        return mGENRagModel.build_encoder(
            opt,
    ...
    def build_decoder(
        ...
        **kwargs,
        ...
        return mGENRagModel.build_decoder(
            opt,
