...
try:
    from transformers import GPT2Tokenizer, T5TokenizerFast, AutoTokenizer, MT5TokenizerFast, MT5Tokenizer
except ImportError:
    raise ImportError(
...
class mGENDictionaryAgent(HuggingFaceDictionaryAgent):
    def get_tokenizer(self, opt): 
        mGEN_model_dir = '/home/evelyn/parley/models/mGEN_model/' #pytorch_model.bin
        return MT5Tokenizer.from_pretrained(mGEN_model_dir, local_files_only=True, truncation=True) #mt5-base
